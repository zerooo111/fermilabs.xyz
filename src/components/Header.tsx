...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 w-full left-0 bg-dark-forest/60 backdrop-blur-lg border-b border-rock/30 z-10 gap-2 h-14 flex items-center">
      <nav className="flex flex-1 h-full justify-between items-center gap-1 text-xl  font-medium container-2xl px-4">
        <div className="flex items-center  h-full md:pl-2 md:pr-4 group hover:text-amber-200 gap-1">
        ...
        <div className="hidden md:flex text-rock/80 items-center h-full  divide-x divide-rock/20">
          <a
            href={LINKS.DOCS}
            target="_blank"
            rel="noreferrer"
        ...
        >
          <span
            className={`block w-6 h-0.5 bg-rock/80 transition-all duration-300 ${
